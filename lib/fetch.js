...
var getSort = function(redis, key, callback, direction) {
		...
		var str = "redis." + type + "(key, 0, -1, function(e, r) {dealErrorRepl(e, r, function(res) {if(res) {dealIndex(res, callback, index);}})});";
		eval(str);
	}
var getMap = function(redis, key, callback, index, flag) {
		...
		eval('redis.' + type + '(key, function(e, r) {dealErrorRepl(e, r, function(res) {if(res) {dealIndex(res, callback, index);}});})');
	};
